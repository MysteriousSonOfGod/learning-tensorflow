...
- 60,000 examples for training (include labels), 10,000 examples for testing (include labels)
- each image has the dimension of 28x28 pixels (784 pixels)
- each pixel has value from 0 - 255 (0: black, 255: white) -> 256 values can occur
